...
For those sets whose templetes did not work as hoped, it is expected that it would take about 30minutes to one hour to fix and redraw the templates, they will then need to be lasercut.
 * The first few templates were cut out of MDF, while, to reduce the cost send on materials, others were then cut out of grey card, which I think proved less effective as they moved around more when trying to drill the new holes and I believe that inaccuracies arose here.
