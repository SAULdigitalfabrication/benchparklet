...
###The Platform
Another aim of this elective was to design a foundation system that would allow the bench to sit on different terrains and be adaptable to small slopes. Many different solutions were proposed and tested, some proved to be too costly while others, which attempted to integrate more into the structure of the bench, actually made the whole bench much too high off of the ground and too unstable. A 1:1 scale prototype for a basic platform with drainage channels and holes was designed and CNC cut out of 12mm plywood, which was actually much mre stable than we anticipated. 
